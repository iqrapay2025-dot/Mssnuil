            ...
            >
              <div className="bg-white p-6 rounded-xl border-l-4 border-l-emerald-600 shadow-lg hover:shadow-xl transition-shadow">
                <div className="flex items-start gap-4">
                  ...
                  <p className="text-gray-700 text-lg">Islam is a complete way of life.</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white p-6 rounded-xl border-l-4 border-l-emerald-600 shadow-lg hover:shadow-xl transition-shadow">
                <div className="flex items-start gap-4">
                  ...
                  <p className="text-gray-700 text-lg">Knowledge must be pursued and applied for the benefit of humanity.</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white p-6 rounded-xl border-l-4 border-l-emerald-600 shadow-lg hover:shadow-xl transition-shadow">
                <div className="flex items-start gap-4">
                  ...
                  <p className="text-gray-700 text-lg">Muslim students must lead with integrity, service, and compassion.</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
