...
export default function MembershipForm() {
  ...
  const handleSubmit = async (e: MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      await fetch('https://script.google.com/macros/s/AKfycbzp6c51QxllGaEyWXGLIkfcypFg7nNIA_jMU5_TLQ0quAPiVmwQmAsO9Iii4bbGOa5L/exec', {
        method: 'POST',
        mode: 'no-cors',
        headers: {
      ...
      setIsSuccess(true);
      toast.success('Registration successful! Welcome to MSSN UNILORIN family! 🎉');
      ...
      <section className="min-h-screen py-24 px-4 bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-700 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl text-white mb-4 font-bold">Join MSSN UNILORIN</h2>
            <div className="w-20 h-1 bg-white mx-auto mb-6"></div>
            <p className="text-xl text-emerald-50 max-w-2xl mx-auto">
              Take the first step towards being part of a vibrant Muslim community dedicated to faith, excellence, and service.
            </p>
          </motion.div>
          ...
          >
            {isSuccess ? (
              ...
              >
                ...
                <h3 className="text-3xl text-white mb-4 font-bold">Welcome to the Family!</h3>
                <p className="text-emerald-50 text-lg">Your registration has been successfully submitted.</p>
              </motion.div>
            ) : (
              <div className="space-y-8">
                ...
                >
                  <label htmlFor="fullname" className="block text-white text-lg mb-3 font-medium">
                  ...
                  <input
                    ...
                    className="w-full px-6 py-4 bg-white/95 backdrop-blur-sm border-2 border-white/30 rounded-2xl focus:outline-none focus:ring-4 focus:ring-white/50 focus:border-white transition-all text-gray-900 placeholder-gray-400 text-lg"
                ...
                >
                  <label htmlFor="faculty" className="block text-white text-lg mb-3 font-medium">
                ...
                >
                  By registering, you agree to be part of the MSSN UNILORIN community and receive updates about our programs and events.
                </motion.p>
              </div>
            )}
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4 text-white">
              <a href="#programs" className="hover:text-emerald-200 transition-colors underline">View Programs</a>
              <span className="text-emerald-300">•</span>
              <a href="#contact" className="hover:text-emerald-200 transition-colors underline">Contact Us</a>
              <span className="text-emerald-300">•</span>
              <a href="#about" className="hover:text-emerald-200 transition-colors underline">Learn More</a>
            </div>
          </motion.div>
        </div>
      </section>
